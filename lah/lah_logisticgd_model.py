...
class LAHLOGISTICGDmodel(L2WSmodel):
    ...
    def initialize_algo(self, input_dict):
        ...
        self.k_steps_train_fn = partial(k_steps_train_lah_logisticgd, num_points=num_points,
                                        jit=self.jit)
        self.k_steps_eval_fn = partial(k_steps_eval_lah_logisticgd, num_points=num_points, 
