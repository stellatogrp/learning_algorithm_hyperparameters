...
from lasco.algo_steps_ista import k_steps_eval_lm_ista, k_steps_train_lm_ista
...
class LMISTAmodel(L2WSmodel):
    def __init__(self, **kwargs):
        super(LMISTAmodel, self).__init__(**kwargs)
    ...
    def initialize_algo(self, input_dict):
        ...
        self.k_steps_train_fn = partial(k_steps_train_lm_ista, lambd=lambd, A=A,
                                        jit=self.jit)
        self.k_steps_eval_fn = partial(k_steps_eval_lm_ista, lambd=lambd, A=A,
                                       jit=self.jit)
