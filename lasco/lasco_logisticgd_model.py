...
class LASCOLOGISTICGDmodel(L2WSmodel):
    def __init__(self, **kwargs):
        super(LASCOLOGISTICGDmodel, self).__init__(**kwargs)

    def initialize_algo(self, input_dict):
        self.factor_static = None
        self.algo = 'lasco_logisticgd'
        ...
        self.lasco_train_inputs = jnp.zeros((N, num_weights))
